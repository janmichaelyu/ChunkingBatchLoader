...
public class XccMLServiceCallChunkWriter extends XccChunkWriter {

	private static final String BATCH_HUB_INPUT_XQY = "/batchHubInput.xqy";

	public XccMLServiceCallChunkWriter(List<ContentSource> contentSources) {
	...
	protected void doWrite(List<DocumentWriteOperation> items, ContentSource contentSource) {
		...
		DocumentWriteOperation first = items.get(0);
